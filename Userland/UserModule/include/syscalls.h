...
extern int32_t sysCreateProcess(int argc, const char* argv[], void* processRip);
extern int32_t sysCreateProcessWithPipeSwap(int argc, const char* argv[], void* processRip, ProcessPipes pipes);
...
extern int sysBlockByUser(uint32_t pid);
